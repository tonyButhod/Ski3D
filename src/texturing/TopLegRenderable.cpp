...
TopLegRenderable::TopLegRenderable( 
      ...
      m_wrapOption(0), m_filterOption(0), m_iBuffer(0)
{
    ...
    if (left)
        read_obj("../meshes/TopLegLeft.obj", tmp_x, m_indices, tmp_n, tmp_tex);
    else
        read_obj("../meshes/TopLegRight.obj", tmp_x, m_indices, tmp_n, tmp_tex);
...
void TopLegRenderable::do_animate(float time)
{
...
void TopLegRenderable::do_keyPressedEvent( sf::Event& e )
{
}
