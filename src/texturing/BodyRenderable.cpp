...
BodyRenderable::BodyRenderable(ShaderProgramPtr shaderProgram, ParticlePtr particle)
      ...
      m_wrapOption(0), m_filterOption(0)
{
    ...
    transformation = glm::scale(transformation,  glm::vec3(2.2,3.0,1.0));
    transformation = glm::translate(transformation,  glm::vec3(0.0,0.5,0.0));
...
void BodyRenderable::do_draw()
{
    ...
    const float &angle = m_controlled->getAngle();
