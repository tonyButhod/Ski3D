...
public:
    ...
    */
     ...
     *
     * @return A const reference to m_cosInnerCutOff.
     */
    const float& cosInnerCutOff() const;

    /**
     * @brief Set the cosinus of the inner cut off angle of the spot.
     *
     * Set the value of m_cosInnerCutOff.
     * @param cosInnerCutOff The new cosinus of the inner cut off angle of the spot.
     */
    void setCosInnerCutOff(float cosInnerCutOff);

    /**
     * @brief Access to the cosinus of the outer cut off angle of the spot.
     *
     * @return A const reference to m_cosOuterCutOff.
     */
    const float &cosOuterCutOff() const;

    /**
     * @brief Set the cosinus of the outer cut off angle of the spot.
     *
     * Set the value of m_cosOuterCutOff.
     * @param outerCutOff The new cosinus of the outer cut off angle of the spot.
     */
    void setCosOuterCutOff(float cosOuterCutOff);
...
private:
    ...
    float m_cosInnerCutOff;    /*!< The cosinus of the inner cutoff angle that specifies the spotlight's inner radius. Everything inside this angle is fully lit by the spotlight. */
    float m_cosOuterCutOff;    /*!< The cosinus of the outer cutoff angle that specifies the spotlight's outer radius. Everything outside this angle is not lit by the spotlight. */
     ...
     */
    std::string cosInnerCutOffName() { return std::string("cosInnerCutOff"); }
     ...
     */
    std::string cosOuterCutOffName() { return std::string("cosOuterCutOff"); }
};
